...
describe("Property Validation Schemas", () => {
  describe("Property Enums", () => {
    ...
    it("should validate sort by options", () => {
      ...
      expect(propertySortByEnum.safeParse("title").success).toBe(true);
  ...
  describe("createPropertySchema", () => {
    ...
    it("should default country to NL", () => {
      const result = createPropertySchema.safeParse(validProperty);
      expect(result.success).toBe(true);
      if (result.success) {
    ...
    it("should default priceNegotiable to true", () => {
      const result = createPropertySchema.safeParse(validProperty);
      expect(result.success).toBe(true);
      if (result.success) {
    ...
    it("should default floors to 1", () => {
      const result = createPropertySchema.safeParse(validProperty);
      expect(result.success).toBe(true);
      if (result.success) {
        expect(result.data.floors).toBe(1);
      }
    });
  });
  ...
  describe("updatePropertySchema", () => {
    ...
    it("should accept rejectionReason", () => {
      const result = updatePropertySchema.safeParse({
        status: "REJECTED",
