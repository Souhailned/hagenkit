---
title: Introducing the DataRAG Help Center
publishedAt: 2025-05-09
summary: Meet the DataRAG Help Center—your hub for guided workflows, workspace tips, and launch best practices.
...
Today, we're excited to launch the [DataRAG Help Center](/help)—a single destination for workspace setup guides, AI workflows, and troubleshooting tips.
...
## Lightning-fast search, everywhere in DataRAG
...
<Image
  alt="Command menu search inside the DataRAG Help Center"
  src="https://imagedelivery.net/r-6-yk-gGPtjfbIST9-8uA/de9cf569-f767-4d0c-7b3e-21605769be00/public"
  width={1607}
  height={946}
/>

Best of all, search is available anywhere inside DataRAG—workspace, editor, or Help Center. Hit `⌘K` (`Ctrl+K` on Windows) to open the command palette and search articles without losing focus.
...
Have feedback or a topic you'd like to see covered? Drop us a note at [support@datarag.io](mailto:support@datarag.io?subject=Help%20Center%20feedback) or message us on X (formerly Twitter) at [@dataragtech](https://twitter.com/dataragtech).
