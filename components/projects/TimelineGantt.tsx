...
export function TimelineGantt({ tasks }: TimelineGanttProps) {
  ...
  const baseWeekStart = startOfWeek(minDate, { weekStartsOn: 1 })

  const effectiveRangeStart = rangeStart ?? baseWeekStart
            ...
            <div className="px-4 py-2 border-b border-border">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  <Button variant="ghost" size="icon" className="h-7 w-7" aria-label="Previous" onClick={handlePrevious}>
                  ...
                  <Button variant="ghost" size="icon" className="h-7 w-7" aria-label="Next" onClick={handleNext}>
                  ...
                  <Button variant="ghost" size="icon" className="h-7 w-7" aria-label="Date range">
                    <CalendarBlank className="h-4 w-4" />
                  </Button>
                  <Button variant="ghost" size="icon" className="h-7 w-7" aria-label="Search tasks">
