...
type ScopeItemData = { id: string; content: string }

type ScopeColumnsProps = {
  inScope: ScopeItemData[]
...
export function ScopeColumns({ inScope, outOfScope, projectId }: ScopeColumnsProps) {
  return (
    <section>
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
        <ScopeList title="In scope" items={inScope} type="IN_SCOPE" projectId={projectId} />
        <ScopeList
          title="Out of scope:"
          items={outOfScope}
          type="OUT_OF_SCOPE"
